use crate::{
    ...
    prepare_transaction, sign_kcc20_transfer, sign_personal_message, sign_reveal, sign_transaction,
    InscriptionRequest, Kcc20TransferRequest, RevealRequest, SendRequest,
};
use jni::{
