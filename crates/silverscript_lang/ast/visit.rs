use super::{
    ConstantAst, ContractAst, ContractFieldAst, Expr, ExprKind, FunctionAst,
    FunctionAttributeArgAst, FunctionAttributeAst, ParamAst, Statement, StructBindingAst,
};
use crate::span::Span;
...
pub fn visit_contract_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    contract: &mut ContractAst<'i>,
) {
    visitor.visit_contract(contract);
}

pub fn walk_contract_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    contract: &mut ContractAst<'i>,
) {
...
pub fn walk_contract_field_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    field: &mut ContractFieldAst<'i>,
) {
...
pub fn walk_constant_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    constant: &mut ConstantAst<'i>,
) {
...
pub fn walk_function_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    function: &mut FunctionAst<'i>,
) {
...
pub fn walk_function_attribute_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    attribute: &mut FunctionAttributeAst<'i>,
) {
...
pub fn walk_function_attribute_arg_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    arg: &mut FunctionAttributeArgAst<'i>,
) {
...
pub fn walk_param_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    param: &mut ParamAst<'i>,
) {
...
pub fn walk_state_binding_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    binding: &mut StructBindingAst<'i>,
) {
...
pub fn walk_statement_mut<'i, V: AstVisitorMut<'i> + ?Sized>(
    visitor: &mut V,
    statement: &mut Statement<'i>,
) {
    match statement {
