...
import init,{addressWithPrefix,deriveBackupKey,generateWallet,importWallet,mnemonicWordStatus,prepareInscription,publicKey,signPersonalMessage}from"./generated/wasm/kaspa_secure_core.mjs";
